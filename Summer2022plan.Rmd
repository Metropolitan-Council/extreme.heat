...
df %>% 
  purrr::map(~ggsave(paste0("figs/", first(.$type),'.png'), height = c(3, 6), width = 6, units = "in", dpi = 200,
  ...
  scale_y_continuous(labels = if (first(.$labels == "dollar")) scales::dollar else scales::percent) +
...
#| out.extra='style="float:right"', 
#| fig.align='right'
knitr::include_graphics("./figs/Age.png")
```
...
#| out.extra='style="float:right"', 
#| fig.align='right'
knitr::include_graphics("./figs/Communications.png")
```
...
#| out.extra='style="float:right"', 
#| fig.align='right'
knitr::include_graphics("./figs/Households.png")
```
...
#| out.extra='style="float:right"', 
#| fig.align='right'
knitr::include_graphics("./figs/Income.png")
```
...
#| out.extra='style="float:right"', 
#| fig.align='right'
knitr::include_graphics("./figs/Race.png")
```
